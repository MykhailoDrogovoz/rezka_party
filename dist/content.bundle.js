...
function repoManagerApplyEmulatorSettings(repo, hostAndPort, emulatorOptions, tokenProvider) {
    ...
    const useSsl = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_2__.isCloudWorkstation)(host);
...
function connectDatabaseEmulator(db, host, port, options = {}) {
    ...
    if ((0,_firebase_util__WEBPACK_IMPORTED_MODULE_2__.isCloudWorkstation)(host)) {
        void (0,_firebase_util__WEBPACK_IMPORTED_MODULE_2__.pingServer)(host);
        (0,_firebase_util__WEBPACK_IMPORTED_MODULE_2__.updateEmulatorBanner)('Database', true);
    }
...
(async function () {
  const firebaseConfig = {
    apiKey: "AIzaSyA6AyNsexmhk1Xb1LeDrCMiYyvzAUKmQmI",
    authDomain: "rezka-party.firebaseapp.com",
    databaseURL: "https://rezka-party-default-rtdb.europe-west1.firebasedatabase.app/",
    projectId: "rezka-party",
    storageBucket: "rezka-party.firebasestorage.app",
    messagingSenderId: "629221824238",
    appId: "1:629221824238:web:1e236ae1c1ffe9874c05ff",
    measurementId: "G-QDSQVDBZCB",
  };
  ...
  const syncRef = (0,firebase_database__WEBPACK_IMPORTED_MODULE_1__.ref)(db, `rooms/${roomId}/syncEvent`);
  const messagesRef = (0,firebase_database__WEBPACK_IMPORTED_MODULE_1__.ref)(db, `rooms/${roomId}/messages`);
  const emojiiRef = (0,firebase_database__WEBPACK_IMPORTED_MODULE_1__.ref)(db, `rooms/${roomId}/emojiis`);

  let isUpdating = false; // To avoid feedback loops when syncing

  // Listen for remote sync events and apply to local video
  (0,firebase_database__WEBPACK_IMPORTED_MODULE_1__.onValue)(syncRef, (snapshot) => {
  ...
  function sendState(type) {
    isUpdating = true;
    (0,firebase_database__WEBPACK_IMPORTED_MODULE_1__.set)(syncRef, {
      type,
  ...
  emojis.forEach((emoji) => {
    ...
    btn.addEventListener("click", () => {
      (0,firebase_database__WEBPACK_IMPORTED_MODULE_1__.push)(emojiiRef, { emojii: emoji });
    });
  ...
  input.addEventListener("keypress", (e) => {
    if (e.key === "Enter" && input.value.trim() !== "") {
      (0,firebase_database__WEBPACK_IMPORTED_MODULE_1__.push)(messagesRef, { message: input.value.trim() });
      input.value = "";
    }
  });

  // Listen for chat messages
  (0,firebase_database__WEBPACK_IMPORTED_MODULE_1__.onValue)(messagesRef, (snapshot) => {
  ...
  (0,firebase_database__WEBPACK_IMPORTED_MODULE_1__.onValue)(emojiiRef, (snapshot) => {
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  if (message.type === "partyCreated") {
    ...
    location.reload(); // Reload to reinitialize overlay with the new party ID
  }

  if (message.type === "partyDisconnected") {
    console.log("[RezkaParty] Party disconnected, cleaning up...");
    // Optional: Hide UI or clean up manually instead of reloading
    setTimeout(() => {
      location.reload();
    }, 300);
  }
